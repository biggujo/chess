...
public class BishopModel extends PieceImpl {
    private static final Supplier<AdvanceProcessors> ADVANCE_PROCESSORS_SUPPLIER = AdvanceProcessorsStorage::forBishop;

    public BishopModel(PlayerType playerType, Point coordinates) {
    ...
    @Override
    public int getValue() {
        return PiecesValues.get(PieceType.BISHOP);
    }
